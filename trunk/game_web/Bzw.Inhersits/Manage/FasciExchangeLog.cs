...
{
    public partial class Manage_FasciExchangeLog : UiCommon.ManageBasePage
    {
        /// <summary>
        /// Head1 控件。
        /// </summary>
        ...
        public void BindLogList()
        {
            DataSet ds = DbSession.Default.FromProc("Web_pGetDataPager")
                ...
                .AddInputParameter("@TableName", DbType.String, "Web_CharmExchangeLog")
                ...
                .AddInputParameter("@OrderBy", DbType.String, "Log_ID desc")
               .ToDataSet();
