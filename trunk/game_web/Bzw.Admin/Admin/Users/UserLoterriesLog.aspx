<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserLoterriesLog.aspx.cs" Inherits="Admin_Users_UserLoterriesLog" %>
		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="#A4B6D7" class="admin_table2">
			<tr>
				<td align="center" bgcolor="F2F8FF" class="title_03">
					<strong><%=UiCommon.StringConfig.GoldName %>变化日志</strong></td>
			</tr>
			<tr>
				<td align="left" bgcolor="F2F8FF" class="title_05">
					...
					<option value="1">比赛赠送</option>
					<option value="2">购买服装赠送</option>
					<option value="3">购买奖品消耗</option>
		...
		<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7" bgcolor="F2F8FF" class="admin_table">
			<tr>
				...
				<th>
					用户名</th>
				<th>
					操作前<%=UiCommon.StringConfig.GoldName %>数</th>
				<th>
					变化<%=UiCommon.StringConfig.GoldName %>数</th>
				<th>
					操作后<%=UiCommon.StringConfig.GoldName %>数</th>
				<th>
					类型</th>
				<th>
					操作时间</th>
			...
			<asp:Repeater ID="rptDataList" runat="server">
				<ItemTemplate>
					<tr>
						...
						<td align="center" style="width:10%;">
							<%# Eval( "ChangeLotteries" )%>
						</td>
						<td align="center" style="width:10%;">
							<%#  Eval( "LotteriesA" )%>
						</td>
						<td align="center" style="width:15%;">
							<%# (Eval("ChangeType").ToString()=="1")?"比赛赠送":Eval("ChangeType").ToString()=="2"?"购买服装赠送":"购买奖品消耗"%>
						</td>
						<td align="center" style="width:10%;">
							<%# Eval("InputDate")%>
						</td>
