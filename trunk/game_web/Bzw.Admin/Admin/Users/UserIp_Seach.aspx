<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Users_UserIp_Seach" Codebehind="UserIp_Seach.aspx.cs" %>
...
<body>
    <form id="form1"  method="get" action="User_List.aspx?act1=post1"> 
    <input type="hidden" id="act1" name="act1" value ="post1" />
...
<tr><td class="title_03"><strong>注册IP统计与查询</strong></td></tr>
<tr><td align="left">
从：<input name="bt" id="bt" type="text" value="<%= beginTime%>" szie="8" Class="put" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'et\')}',dateFmt:'yyyy-MM-dd'})"/>
到：<input name="et" id="et" type="text" value="<%=EndTime %>"  szie="8" Class="put"  onfocus="WdatePicker({minDate:'#F{$dp.$D(\'bt\')}',dateFmt:'yyyy-MM-dd'})"/>
IP：<input name="ip" type="text" value="127.0.0.1" size="15" Class="put" maxlength="15"/>

<input name="dc" type="checkbox" value="1"  Class="put"/>每日统计
