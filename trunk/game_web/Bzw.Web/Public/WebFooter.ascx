...
<div id="footer">
			<div id="dz">
				...
				<p class="cb fl text02">禁止任何利用1对1竞技进行赌博的行为，让我们共同净化游戏环境，一旦发现有违反用户协议的行为（包括赌博行为），我们将立刻封杀帐号！<br />
							   <span class="text03">版权所有 © <%= SiteConfig.GetParaValue("Copyright")%>  1对1竞技游戏科技有限公司 版权所有 </span><br />
