<%@ Page Language="C#" AutoEventWireup="true" Inherits="Bzw.Inhersits.Manage.Manage_BuyVipLog" %>
       ...
       <div id="content01">
            ...
            <div id="sub_nr" style="margin-top: 10px;">
						...
						<BZW:WebLogBannister ID="weblogbannister1" runat="server" />
						  ...
						  <div class="rank_title">购买VIP记录</div>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab01">
								<tr>
									<td style="text-align: left; text-indent: 20px; padding: 0 0 3px 0;">
										...
										<span style="vertical-align: middle;">按时间段搜索：从&nbsp;<input type="text"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab01">
							...
							<tr>
								...
								<th>
									花费<%=ConfigurationManager.AppSettings["moneyName"].ToString()%></th>
								<th>
									时间</th>
									<th>赠送玩家</th>
							</tr>
