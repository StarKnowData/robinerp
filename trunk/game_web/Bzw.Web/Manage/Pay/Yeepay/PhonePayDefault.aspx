<%@ Page Language="C#" AutoEventWireup="true" Inherits="Bzw.Inhersits.Manage.Pay.Yeepay.Manage_Pay_Yeepay_PhonePayDefault" %>
                        ...
                        <tr>
                            ...
                            <td valign="middle">
                                <asp:DropDownList ID="PayMoney" runat="server">
                                    ...
                                    <asp:ListItem Value="300">300元</asp:ListItem>
                                    <asp:ListItem Value="500">500元</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
