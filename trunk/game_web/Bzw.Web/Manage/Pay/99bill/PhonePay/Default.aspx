<%@ Page Language="C#" AutoEventWireup="true" Inherits="Bzw.Inhersits.Manage.Pay._99bill.PhonePay.Manage_Pay_99bill_PhonePay_Default" %>
...
<!--content-->
 ...
 <div id="right">
        <div class="right_con_title">  <span>当前位置：<a href="/Default.aspx" title="首页">首页</a> 
            &gt; <a href="/Manage/Pay/Default.aspx" title="充值">充值</a> &gt; <a href="/Manage/Pay/99bill/PhonePay/Default.aspx" title="快钱网上银行转帐充值">
             快钱神州行卡密充值</a></span>
      <h1><asp:Label ID="lblMsg" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
           快钱神州行卡密充值</h1></div>
      <div class="rightbox" >
        <div class="prize_detail">
        <h6>您选择了 快钱神州行卡密充值方式</h6>        
        ...
        <input name="txtUserName" type="text"id="txtUserName" size="20" value="<%=UiCommon.UserLoginInfo.UserName %>" class="input" />
					...
					<tr>
						...
						<select id="Select1" name="PayMoney">
