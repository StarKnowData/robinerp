...
#define DTK_GP_ZRECORD					11									//修改写Z登录记录的时机，确保网络卡的时候，不至于导致用户登录不上 2009-4-30 zxj

#define DTK_GP_GET_ROOM_LIST_PEOCOUNT	8									//pppp
#define	DTK_GP_LOCK_UNLOCK_ACCOUNT		12									//锁定机器或解除锁定 zxj 2009-11-16
#define DTK_GP_CHECK_ROOM_PASSWD		10									// 进入密码房间 Add by lxl 2010-10-08
...
#define	DTR_GP_ACCOUNT_LOCKED			29									//本帐号锁定了某台机器，反正不是当前正在登录这台	zxj 2009-11-12
#define	DTR_GP_LOCK_SUCCESS				30									//锁定成功	zxj 2009-11-12
#define	DTR_GP_MATHINE_UNLOCK			31									//帐号根本就没锁定某台机器 zxj 2009-11-12
#define	DTR_GP_UNLOCK_SUCCESS			32									//解锁成功	zxj 2009-11-16
#define	DTR_GP_CODE_ERROR				33									//机器码不匹配
#define DTK_GR_CHECK_VERSION			34									//检查版本 zxd add for check version20100312
#define DTK_GP_GET_SELLGAMELIST			35									//获取销售列表  add by wyl
