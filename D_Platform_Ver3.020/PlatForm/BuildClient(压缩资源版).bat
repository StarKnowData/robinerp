...
rem echo 重新编译Client\Resource2003
rem del .\Client\Resource2003\无技术支持(资源压缩)\*.* /Q
rem devenv ".\Client\Resource2003\AFCResDll.vcproj" /build 无技术支持(资源压缩) >nul

rem echo 重新编译Client\UILibrary2003
rem del .\Client\UILibrary2003\无技术支持(资源压缩)\*.* /Q
rem devenv ".\Client\UILibrary2003\AFC.vcproj" /build 无技术支持(资源压缩) >nul
