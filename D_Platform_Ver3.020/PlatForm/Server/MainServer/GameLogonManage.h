...
///{{ Added by zxd 20100722 实现用于GM管理工具的功能接口
	, public IGMFunction
	, public IDistriManagerNetBase
/// Added by zxd 20100722}}
{
	/// {{Added by zxd 20100722 引入GM管理工具
private:
...
public:
	...
	{
		return m_pDistriManager->SendBatchData(pData, uBufLen, bMainID, bAssistantID, bHandleCode);
	}
	/// 根据用户ID获取Socket序号
...
public:
	...
	CString m_strSmsContent[10];													//短讯格式
