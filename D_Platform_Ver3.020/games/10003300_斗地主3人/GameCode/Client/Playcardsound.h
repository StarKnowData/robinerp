...
#define SOUND_SHOW_CARD 			0xC0				//地主亮牌
...
//声音通用设置
BOOL SetPlaySound(BYTE bSoundType,bool bisboy = true);
//出牌牌型声音設置
...
//播入场景声音
HWND SetSceneSound(BYTE iSceneSound,HWND hParent,BOOL IsBoy = TRUE,int iVal = -1 ,int iDialectType = 0 );
