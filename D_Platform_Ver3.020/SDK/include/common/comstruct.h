...
#define GRR_NOT_COST_POINT		0x00080000L		///金币场不扣积分  add by lxl 2010-10-26

#define GRR_CONTEST				0x00100000L		///定时淘汰比赛场

#define GRR_GAME_U3D			0x00200000L		///U3D遊戲

///百家乐 add by wlr 20090714
#define DESK_TYPE_NORMAL		0		///
#define DESK_TYPE_BJL			1		///

#define		HUNDRED_PEOPLE_DESK_GAME_NAME   10301800					///百人桌游戏编号 add by ramon
...
{
    int                         iRoomFlag[2];       // PengJiLin, 2011-4-2, 不使用的字段，占位用
    ...
    int                         iRoomInfoFlag[2];   // PengJiLin, 2011-4-2, 不使用的字段，占位用

	///设置信息
	UINT						uComType;							///游戏类型
	UINT						uDeskType;							///游戏桌类型，主要为添加百家乐桌 add by wlr 20090714
...
//比赛专用
	...
	char			szRoomPassWord[61];						//房间密码	Add By lxl 2010-10-08，房间加密功能
	///服务器信息
