<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaser.Master" AutoEventWireup="true" CodeBehind="UserLogin.aspx.cs" Inherits="QPS.Web.UserLogin" %>
...
<div class="mid">
     <div class="nyleft">
          ...
          <div class="lxfs">
               <h3><a href="tencent://message/?uin=2637416916&Site=八棋赢棋牌游戏&Menu=yes">企业QQ<br/>在线客服</a></h3>
          </div>
     </div>
     <div class="nyright">
               ...
               <div class="zcb">
                    <div class="dla" id="cotant_1">
                       ...
                       <img id="imgCode" alt="看不清，请点击我！" src="checkcode.aspx"  style="cursor: hand; width: 76px; height: 21px; margin-top:20px;" onclick="this.src=this.src+'?'"  /></li>
                               <li>
                                   <asp:Button ID="btnLogin" runat="server" Text=""  class="zca5" 
                     ...
                     <div class="zcnrb">
                         <span>还没有八棋赢棋牌室联盟账号？</span>
                          <a href="UserReg.aspx"><img src="images/nyimg8.jpg"></a>
                     </div>
                </div>
          </div>
