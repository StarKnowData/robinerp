<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveMoneyEdit.aspx.cs" Inherits="Admin_SConfig_ReceiveMoneyEdit" %>
	...
	<table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7" bgcolor="F2F8FF" class="admin_table">
		...
		<tr>
			<td align="center" colspan="2">
				<asp:Button ID="Button1" runat="server" Text=" 修 改 " OnClick="ReceiveMoneyEdit" class="put" />
			</td>
		</tr>
	</table>
    </div>
