<%@ Page Language="C#" AutoEventWireup="true" Inherits="Admin_Users_UserList_Seach_UserMoneySeach" Codebehind="UserMoneySeach.aspx.cs" %>
...
<body>
    <form id="form1" runat="server" method="post">
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
           ...
           <asp:Panel ID="YesMoney" runat="server" Width="100%" Visible="true"><tr>
                <td>
        ...
        <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <input id="Button2" type="button" runat="server" value=" 查 询 " Class="put" onserverclick="SearchPage"  /></td>
            </tr>
        </table>
    </form>
</body>
