<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayToPoint.aspx.cs" Inherits="Admin_Pay_PayToPoint" %>
    ...
    <table width="100%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolor="A4B6D7"
        ...
        <tr>
            <td class="title_03" colspan="15">
                <strong><font color="red">积分充值<%=lbState %>记录列表</font></strong> 
            </td>
        </tr>
        <tr>
            ...
            <td colspan="8" class="title_03" align="right">
                ...
                </select>&nbsp;排序<select id="ord" name="ord"><option value="addtime">充值时间</option><option value="paymoney">充值金额</option></select>
        ...
        <asp:Repeater ID="rptDataList" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <a href='PayToPoint.aspx?id=<%# Eval("ID") %>&act=del' onclick="javascript:return confirm('您确定要删除当前记录吗？删除后将不能恢复!!');">
