		...
		<form method="POST" name='Login' id="Login" action="" runat="server" onsubmit='return CheckForm();'>
			<center>
				<table width="68%" border="1" align="center" cellpadding="3" cellspacing="0" bordercolorlight="#335078"
					...
					<tr>
						<td height="25" align="left" bgcolor="#DFE8F0" style="border-top: medium none; border-bottom: medium none;">
							<div align="left">
								分配权限：<br /><div style="padding-left:18px; line-height:30px;">
					...
					<ItemTemplate>
						<tr valign="middle">
							...
							<td width="53" height="24" bgcolor="#E0E9F1">
								<a href="Edit_AdminUser.aspx?id=<%# Eval("id")%>">修改</a></td>
