...
{
    public partial class Manage_LotteryLog : UiCommon.ManageBasePage
    {
        /// <summary>
        /// Head1 控件。
        /// </summary>
        ...
        public void BindLogList()
        {
            ...
            int counts = 0;
            DataTable dt = Utility.SqlHelper.ExecuteDataPager("Web_VLotterLog", "ID", "*", "AddDate", 1, anpPageIndex.PageSize,PageIndex, out counts, "");
